...
/**
 * The StationCrossfader allows you to tie music player actions (such as station changes
 ...
 *
 *    StationCrossfader *cf = [StationCrossfade stationCrossfaderWithInitialStation:@{ @"bpm": @"slow" },
 *                                               andCuePoints: @[
...
@interface StationCrossfader : NSObject

/**
 * Create a new StationCrossfader instance. The station passed in is considered the
 ...
 *      AdaptrAudioPlayer getStationWithOptionKey:Value: to get the intial station for playback
 ...
 * @return a new StationCrossfader object
 */
...
/**
 * Create a new StationCrossfader instance with a default station. Cue points can be
 ...
 *      AdaptrAudioPlayer getStationWithOptionKey:Value: to find a station
...
/**
 * This call causes the active station in the shared AdaptrAudioPlayer to be updated to match
