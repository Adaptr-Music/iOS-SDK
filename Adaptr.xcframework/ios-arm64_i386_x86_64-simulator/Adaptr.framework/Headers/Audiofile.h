 ...
 * property.
 */
@interface Audiofile : NSObject <NSCopying>
 ...
 *
 *  @return returns new Audiofile instance
 */
 ...
 *
 *  @param jsonDictionary JSON dictionary
 *  @param station Station that the play was created in
 *
 *  @return returns new Audiofile instance
 */
 ...
 *  use the `[AdaptrAudioPlayer like]` method instead.
 */
- (void)like;
 ...
 *  Assigns corresponding values to <liked> and <disliked> properties. Note, this
 *  is for internal use, and shouldn't be used to respond to user input -
 *  use the `[AdaptrAudioPlayer dislike]` method instead.
 ...
 *  Assigns corresponding values to <liked> and <disliked> properties. Note, this
 *  is for internal use, and shouldn't be used to respond to user input -
 *  use the `[AdaptrAudioPlayer unlike]` method instead.
